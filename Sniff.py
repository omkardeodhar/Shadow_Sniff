...
*                                                      *
*    WARNING: THIS TOOL IS FOR EDUCATIONAL             *
*    AND AUTHORIZED USE ONLY. UNAUTHORIZED             *
*    ACCESS TO NETWORK TRAFFIC IS ILLEGAL              *
...
packet_rate = int (packet_count / elapsed_time if elapsed_time > 0 else 0)

print(f"\nCapture completed. Elapsed time: {elapsed_time} seconds")
print(f"Average packet capture rate is: {packet_rate} packets per second")
